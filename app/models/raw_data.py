...
class RawData(Base, BaseTableMixin):
    ...
    # 基本信息
    name: Mapped[str] = mapped_column(String(100), nullable=False, comment="数据对象名称，如 pg_orders_raw")
    description: Mapped[str | None] = mapped_column(Text, nullable=True, comment="数据对象描述")
    raw_type: Mapped[str] = mapped_column(String(20), nullable=False, comment="数据对象类型: database_table/file")
